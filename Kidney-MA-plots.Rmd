## MA plot for Kidney 2DG 4wks {.tabset .tabset-fade .tabset-pills}
```{r Kidney 2DG 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Kidney control 4wks {.tabset .tabset-fade .tabset-pills}
```{r Kidney control 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Kidney 2DG 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Kidney 2DG 96hrs MA plot, results='asis',cache=TRUE}
...
## MA plot for Kidney control 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Kidney control 96hrs MA plot, results='asis',cache=TRUE}
