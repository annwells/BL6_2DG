...
```{r Kidney 2DG 4wks MA plot, results='asis'}
...
```{r Kidney control 4wks MA plot, results='asis'}
...
```{r Kidney 2DG 96hrs MA plot, results='asis'}
...
```{r Kidney control 96hrs MA plot, results='asis'}
