...
```{r Hippocampus 2DG 4wks MA plot, results='asis'}
...
```{r Hippocampus control 4wks MA plot, results='asis'}
...
```{r Hippocampus 2DG 96hrs MA plot, results='asis'}
...
```{r Hippocampus control 96hrs MA plot, results='asis'}
