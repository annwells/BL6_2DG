---
title: "Chang B6 96hr 4wk 2DG Module Sample Contribution Hippocampus"
author: Ann Wells
...
eigens <- read.csv(here("Data","Hippocampus","log.tdata.FPKM.sample.info.subset.hippocampus.WGCNA.module.eigens.csv"), header=T)
```
...
```{r, results = 'asis'}
eigen.expression(eigens,log.tdata.FPKM.sample.info.subset.hippocampus)
```
