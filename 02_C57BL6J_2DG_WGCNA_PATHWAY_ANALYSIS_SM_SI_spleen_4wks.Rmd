---
title: "Chang B6 96hr 4wk 2DG Pathway Analysis Skeletal Muscle, Small Intestine, and Spleen 4wks"
author: Ann Wells
...
```{r}
WGCNA<-read.table(here("Data","SM.SI.spleen.4wks","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.4wks.WGCNA.module.membership.csv"), header=T)

Data_setup(WGCNA, file = "Annotated_genes_in_SM_SI_spleen_4wks_WGCNA_Chang_B6_96hr_4wk.RData", folder="SM.SI.spleen.4wks")

Matched<-readRDS(here("Data","SM.SI.spleen.4wks","Annotated_genes_in_SM_SI_spleen_4wks_WGCNA_Chang_B6_96hr_4wk.RData"))
  
pathways(Matched, pathwayfile = "Chang_B6_96hr_4wk_gprofiler_pathway_annotation_list_SM_SI_spleen_4wks_WGCNA.RData", genefile = "Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_SM_SI_spleen_4wks_WGCNA.RData", folder = "SM.SI.spleen.4wks")
...
#pdf("Counts_of_each_pathway_identified_within_SM.SI.spleen.4wks.pdf")
