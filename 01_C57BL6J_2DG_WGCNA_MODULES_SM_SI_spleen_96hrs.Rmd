---
title: "Module Generation SM.SI.spleen.96hrs"
author: Ann Wells
...
```{r load_data}
log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA <- readRDS(here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.missing.WGCNA.RData"))
```
...
threshold <- softthreshold(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA)
```
...
adj.mtx <- adjacency(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA, power=soft.power)
...
```{r}
me.list <- moduleEigengenes(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA, colors=cols) 
...
merge <- mergeCloseModules(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA, cols, cutHeight=merge.thresh, verbose=0)
...
saveRDS(net.deg,here("Data","SM.SI.spleen.96hrs","Chang_2DG_BL6_connectivity_SM_SI_spleen_96hrs.RData"))
head(net.deg)
```
...
colnames(merged.mes) <- paste0("log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA_", module.labels)
module.eigens <- merged.mes
# Add log.tdata.FPKM.sample.info.subset.WGCNA tag to labels
module.labels <- paste0("log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA_", module.labels)

# Generate and store metabolite membership
module.membership <- data.frame(
  Gene=colnames(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA),
  Module=paste0("log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA_", merged.cols)
)

saveRDS(module.labels, here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.labels.RData"))
saveRDS(module.eigens, here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.eigens.RData"))
saveRDS(module.membership, here("Data","SM.SI.spleen.96hrs", "log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.membership.RData"))

write.table(module.labels, here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.labels.csv"), row.names=F, col.names=F, sep=",")
write.csv(module.eigens, here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.eigens.csv"))
write.csv(module.membership, here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.membership.csv"), row.names=F)
```
