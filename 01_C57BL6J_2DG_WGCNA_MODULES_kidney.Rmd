---
title: "Module Generation Kidney"
author: Ann Wells
...
soft <- pickSoftThreshold(log.tdata.FPKM.sample.info.subset.kidney.WGCNA, powerVector=powers, verbose=0)
```
...
```{r}
me.list <- moduleEigengenes(log.tdata.FPKM.sample.info.subset.kidney.WGCNA, colors=cols) 
...
merge <- mergeCloseModules(log.tdata.FPKM.sample.info.subset.kidney.WGCNA, cols, cutHeight=merge.thresh, verbose=0)
