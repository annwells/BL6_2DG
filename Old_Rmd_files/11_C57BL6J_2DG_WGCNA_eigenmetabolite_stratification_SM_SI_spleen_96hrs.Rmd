---
title: "Chang B6 96hr 4wk 2DG Eigenmetabolite Stratification Skeletal Muscle, Small Intestine, and Spleen 96hrs"
author: Ann Wells
...
eigenmetabolite(factors,log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs)
```
...
model.data = dplyr::bind_cols(module.eigens[rownames(log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs),], log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs[,c("Treatment","Tissue")])
...
for (m in module.labels) {
  p = plot.interaction(model.data, "Tissue", "Treatment", resp = m)
