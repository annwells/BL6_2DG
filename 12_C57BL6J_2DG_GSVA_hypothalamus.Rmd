...
tES <- GSVA.modules(modules, log.data.FPKM.subset.hypothalamus)

saveRDS(tES,here("Data","Hypothalamus","GSVA.modules.hypothalamus.RData"))
```
...
GSVA.table(log.tdata.FPKM.sample.info.subset.hypothalamus, tES)
```