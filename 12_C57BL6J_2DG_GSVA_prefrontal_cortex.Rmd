---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Prefrontal Cortex"
author: Ann Wells
...
log.data.FPKM.subset.prefrontal.cortex <- log.tdata.FPKM.sample.info.subset.prefrontal.cortex %>%
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.prefrontal.cortex)

saveRDS(tES,here("Data","Prefrontal Cortex","GSVA.modules.prefrontal.cortex.RData"))
```
...
## ANOVA Table{.tabset .tabset-fade .tabset-pills}
...
GSVA.table(log.tdata.FPKM.sample.info.subset.prefrontal.cortex, tES)
```