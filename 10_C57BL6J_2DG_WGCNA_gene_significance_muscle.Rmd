---
title: "Chang B6 96hr 4wk 2DG Gene Connectivity with Traits Skeletal Muscle"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.skeletal.muscle <- cbind(log.tdata.FPKM.sample.info.subset.skeletal.muscle, Time.Treat = paste(log.tdata.FPKM.sample.info.subset.skeletal.muscle$Time, log.tdata.FPKM.sample.info.subset.skeletal.muscle$Treatment))
...
gene.significance(factors,log.tdata.FPKM.sample.info.subset.skeletal.muscle, modules)
```
