---
title: "Chang B6 96hr 4wk 2DG Gene Connectivity with Traits Liver"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.liver <- cbind(log.tdata.FPKM.sample.info.subset.liver, Time.Treat = paste(log.tdata.FPKM.sample.info.subset.liver$Time, log.tdata.FPKM.sample.info.subset.liver$Treatment))
...
gene.significance(factors,log.tdata.FPKM.sample.info.subset.liver, modules)
```
