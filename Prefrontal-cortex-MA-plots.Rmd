...
```{r Prefrontal Cortex 2DG 4wks MA plot, results='asis'}
...
```{r Prefrontal Cortex control 4wks MA plot, results='asis'}
...
```{r Prefrontal Cortex 2DG 96hrs MA plot, results='asis'}
...
```{r Prefrontal Cortex control 96hrs MA plot, results='asis'}
