---
title: "Hub Genes Skeletal Muscle, Small Intestine, and Spleen 96hrs"
author: Ann Wells
...
for(m in module.labels) {
    ...
    cat("\n###",name, "{.tabset .tabset-fade .tabset-pills}","\n")
          for(i in 1:10){
             cat("\n####",hub.met$gene[i],"\n")
             m <- art(data = log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs, log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs[,hub.met$Gene[i]] ~ Treatment*Tissue)
             model <- anova(m)
