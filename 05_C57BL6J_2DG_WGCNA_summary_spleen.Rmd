...
2 pathways were identified in the **Indianred1** module. The pathways were FMO oxidises nucleophiles and regulation of insulin-like growth factor transport and uptake by insulin-like growth factor binding proteins.

## Indianred4

64 pathways were identified in the **Indianred4** module. The pathways were related to chromatin, B cell receptor signaling, autoimmune disease, immunity, insulin resistance, interleukins, natural killer cells, NF-kappa B signaling, Notch signaling, T cel receptor signaling, Th1 and 2 differentiation, and Th17 differentiation.
...
32 pathways were identified in the **Tan4** module. The pathways were related to metabolism, mitochondrial metabolism, respiratory electron transport, oxidative phsophorylation, TCA cycle, thermogenesis, and translation.
...
When assessing the overall sample contribution through their summary eigengenes it appears that for **palevioletred3** 4wk mice, independent of treatment had half positive and half negative effects while 96 hr mice, indepednent of treatment, had a mostly positive effect, indicating that there are both over and under-expressed genes for 4wks and mostly over-expressed genes 96 hrs.
