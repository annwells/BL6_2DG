---
title: "Chang B6 96hr 4wk 2DG Gene Connectivity with Traits Small Intestine"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.small.intestine <- cbind(log.tdata.FPKM.sample.info.subset.small.intestine, Time.Treat = paste(log.tdata.FPKM.sample.info.subset.small.intestine$Time,log.tdata.FPKM.sample.info.subset.small.intestine$Treatment))
...
gene.significance(factors,log.tdata.FPKM.sample.info.subset.small.intestine, modules)
```
