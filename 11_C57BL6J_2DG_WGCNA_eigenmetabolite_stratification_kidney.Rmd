---
title: "Chang B6 96hr 4wk 2DG Eigenmetabolite Stratification Kidney"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.kidney$Treatment[log.tdata.FPKM.sample.info.subset.kidney$Treatment=="None"] <- "Control"

log.tdata.FPKM.sample.info.subset.kidney <- cbind(log.tdata.FPKM.sample.info.subset.kidney, Time.Treatment = paste(log.tdata.FPKM.sample.info.subset.kidney$Time, log.tdata.FPKM.sample.info.subset.kidney$Treatment))

module.labels <- readRDS(here("Data","Kidney","log.tdata.FPKM.sample.info.subset.kidney.WGCNA.module.labels.RData"))
module.eigens <- readRDS(here("Data","Kidney","log.tdata.FPKM.sample.info.subset.kidney.WGCNA.module.eigens.RData"))
...
eigenmetabolite(factors,log.tdata.FPKM.sample.info.subset.kidney)
```
...
model.data = dplyr::bind_cols(module.eigens[rownames(log.tdata.FPKM.sample.info.subset.kidney),], log.tdata.FPKM.sample.info.subset.kidney[,c("Time","Treatment")])
