---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Heart"
author: Ann Wells
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.heart)

#saveRDS(tES, here("Data","Heart","GSVA.modules.heart.RData"))
```
...
Aligned rank transformation was used to determine which factors significantly altered each pathway.
...
GSVA.table(log.tdata.FPKM.sample.info.subset.heart, tES)
```