---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Hippocampus"
author: Ann Wells
...
log.data.FPKM.subset.hippocampus <- log.tdata.FPKM.sample.info.subset.hippocampus %>%
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.hippocampus)
```
...
for(j in 1:length(tES)){
  ...
  m <- art(data = log.tdata.FPKM.sample.info.subset.hippocampus, tES[[j]][,i] ~ Time*Treatment)
