---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Kidney"
author: Ann Wells
...
log.data.FPKM.subset.kidney <- log.tdata.FPKM.sample.info.subset.kidney %>%
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.kidney)
tES[[3]] <- as.matrix(tES[[3]])
colnames(tES[[3]]) <- "KEGG root term"
```
...
GSVA.table(log.tdata.FPKM.sample.info.subset.kidney, tES)
```