...
log.tdata.FPKM.sample.info.subset.hypothalamus$Tissue <- as.factor(log.tdata.FPKM.sample.info.subset.hypothalamus$Tissue)
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset.hypothalamus, log.tdata.FPKM.sample.info.subset.hypothalamus[,genes[i]] ~ Time*Treatment)
...
saveRDS(stat.table,here("Data","Hypothalamus","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_hypothalamus.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","Hypothalamus","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_hypothalamus.RData"))
