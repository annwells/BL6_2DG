...
```{r Small Intestine 2DG 4wks MA plot, results='asis'}
...
```{r Small Intestine control 4wks MA plot, results='asis'}
...
```{r Small Intestine 2DG 96hrs MA plot, results='asis'}
...
```{r Small Intestine control 96hrs MA plot, results='asis'}
