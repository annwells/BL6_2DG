## MA plot for Small Intestine 2DG 4wks {.tabset .tabset-fade .tabset-pills}
```{r Small Intestine 2DG 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Small Intestine control 4wks {.tabset .tabset-fade .tabset-pills}
```{r Small Intestine control 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Small Intestine 2DG 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Small Intestine 2DG 96hrs MA plot, results='asis',cache=TRUE}
...
## MA plot for Small Intestine control 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Small Intestine control 96hrs MA plot, results='asis',cache=TRUE}
