---
title: "Chang B6 96hr 4wk 2DG Module Sample Contribution Skeletal Muscle, Small Intestine, and Spleen"
author: Ann Wells
...
eigens <- read.csv(here("Data","SM.SI.spleen","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.WGCNA.module.eigens.csv"), header=T)
```
...
```{r, results = 'asis'}
eigen.expression(eigens,log.tdata.FPKM.sample.info.subset.SM.SI.spleen)
```
