---
title: "Chang B6 96hr 4wk 2DG Gene Connectivity with Traits Kidney"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.kidney <- cbind(log.tdata.FPKM.sample.info.subset.kidney, Time.Treat = paste(log.tdata.FPKM.sample.info.subset.kidney$Time,log.tdata.FPKM.sample.info.subset.kidney$Treatment))
...
gene.significance(factors,log.tdata.FPKM.sample.info.subset.kidney, modules)
```
