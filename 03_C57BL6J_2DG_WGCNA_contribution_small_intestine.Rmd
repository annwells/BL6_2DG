---
title: "Chang B6 96hr 4wk 2DG contribution Small Intestine"
author: Ann Wells
...
heat <- pheatmap(moduleTraitCor, main = paste("Module-trait relationships"), display_numbers = textMatrix,color=colorRampPalette(brewer.pal(n = 12, name = "Paired"))(10), cluster_rows = F, cluster_cols = F, fontsize_number = 4, angle_col = 45, number_color = "black", border_color = "white", fontsize_row = 7)
heat
...
moduleTraitPvalue %>%
  download_this(
    output_name = "Small Intestine Module-Trait Relationship",
...
```{r, child="knitr-WGCNA-contribution-time.Rmd"}
```

## Treatment by Time {.tabset .tabset-fade .tabset-pills}
```{r, child="knitr-WGCNA-contribution-treat-time.Rmd"}
```
