---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Spleen"
author: Ann Wells
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.spleen)
```
...
for(j in 1:length(tES)){
  ...
  m <- art(data = log.tdata.FPKM.sample.info.subset.spleen, tES[[j]][,i] ~ Time*Treatment)
