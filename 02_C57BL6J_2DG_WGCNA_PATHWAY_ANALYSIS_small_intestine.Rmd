---
title: "Pathway Analysis Small Intestine"
author: Ann Wells
...
```{r, cache=TRUE}
WGCNA<-read.table(here("Data","Small Intestine","log.tdata.FPKM.sample.info.subset.small.intestine.WGCNA.module.membership.csv"), header=T)

Data_setup(WGCNA, file = "Annotated_genes_in_small_intestine_WGCNA_Chang_B6_96hr_4wk.RData", folder="Small Intestine")

Matched<-readRDS(here("Data","Small Intestine","Annotated_genes_in_small_intestine_WGCNA_Chang_B6_96hr_4wk.RData"))
  
pathways(Matched, pathwayfile = "Chang_B6_96hr_4wk_gprofiler_pathway_annotation_list_small_intestine_WGCNA.RData", genefile = "Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_small_intestine_WGCNA.RData", folder = "Small Intestine")
...
### Yellow4
```{r, results='asis'}
if(class(WGCNA.pathway[[46]]) == "numeric"){
   print("No pathways significantly overrepresented")
   } else {DT.table.path(WGCNA.pathway[[46]][c(11,3:6)])}
```
...
#pdf("Counts_of_each_pathway_identified_within_small_intestine.pdf")
