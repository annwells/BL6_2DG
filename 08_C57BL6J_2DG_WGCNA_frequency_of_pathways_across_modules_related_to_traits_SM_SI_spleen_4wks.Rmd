---
title: "Chang B6 96hr 4wk 2DG Frequency of Pathways by Module-Trait Relationship Skeletal Muscle, Small Intestine, and Spleen 4wks"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.SM.SI.spleen.4wks <- log.tdata.FPKM.sample.info %>% rownames_to_column() %>% filter(Tissue %in% c("Skeletal Muscle", "Small Intestine", "Spleen")) %>% filter(Time == "4 wks") %>% column_to_rownames()
