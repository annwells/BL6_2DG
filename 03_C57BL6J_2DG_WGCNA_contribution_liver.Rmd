---
title: "Chang B6 96hr 4wk 2DG contribution Liver"
author: Ann Wells
...
as.data.frame(moduleTraitPvalue) %>%
  download_this(
    output_name = "Liver Module-Trait Relationship",
...
# 
# Sigmodules <- as.data.frame(cbind(MEs$darkturquoise,MEs$darkolivegreen,MEs$skyblue3))
# colnames(Sigmodules) <- c("darkturquoise","darkolivegreen","skyblue3")
# 
