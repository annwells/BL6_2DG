## MA plot for Heart 2DG 4wks {.tabset .tabset-fade .tabset-pills}
```{r Heart 2DG 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Heart control 4wks {.tabset .tabset-fade .tabset-pills}
```{r Heart control 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Heart 2DG 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Heart 2DG 96hrs MA plot, results='asis',cache=TRUE}
...
## MA plot for Heart control 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Heart control 96hrs MA plot, results='asis',cache=TRUE}
