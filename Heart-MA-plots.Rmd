...
```{r Heart 2DG 4wks MA plot, results='asis'}
...
```{r Heart control 4wks MA plot, results='asis'}
...
```{r Heart 2DG 96hrs MA plot, results='asis'}
...
```{r Heart control 96hrs MA plot, results='asis'}
