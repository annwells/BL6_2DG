---
title: "Chang B6 96hr 4wk 2DG Module Sample Contribution Liver"
author: Ann Wells
...
eigens <- read.csv(here("Data","Liver","log.tdata.FPKM.sample.info.subset.liver.WGCNA.module.eigens.csv"), header=T)
```
...
```{r, results = 'asis'}
eigen.expression(eigens,log.tdata.FPKM.sample.info.subset.liver)
```
