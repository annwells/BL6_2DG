...
count <- count.pathways.traits(tissue.pathways)
```
...
### Time
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(time.pathways)
```
...
### Treatment
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(treat.pathways)
```
...
### Time by Treatment
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(time.treat.pathways)
```
...
### Tissue by Time
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(tissue.time.pathways)
```
...
### Tissue by Treatment
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(tissue.treat.pathways)
```
...
```{r, results='asis', cache=TRUE}
count <- count.pathways.traits(tissue.time.treat.pathways)
```
