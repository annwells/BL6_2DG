---
title: "Chang B6 96hr 4wk 2DG Module Sample Contribution Skeletal Muscle"
author: Ann Wells
...
eigens <- read.csv(here("Data","Skeletal Muscle","log.tdata.FPKM.sample.info.subset.skeletal.muscle.WGCNA.module.eigens.csv"), header=T)
```
...
```{r, results = 'asis'}
eigen.expression(eigens,log.tdata.FPKM.sample.info.subset.muscle)
```
