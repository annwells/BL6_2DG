...
### Green
```{r Hippocampus green, echo=FALSE}
...
### Coral1
```{r Hippocampus coral1, echo=FALSE}
...
### Darkslateblue
```{r Hippocampus darkslateblue, echo=FALSE}
...
### Darkolivegreen
```{r Hippocampus darkolivegreen, echo=FALSE}
...
### Khaki3
```{r Hippocampus khaki3, echo=FALSE}
...
### Midnightblue
```{r Hypothalamus midnightblue, echo=FALSE}
...
### Bisque4
```{r Hypothalamus bisque4, echo=FALSE}
...
### Lightyellow
```{r Kidney lightyellow, echo=FALSE}
...
### Darkturquoise
```{r Liver darkturquoise, echo=FALSE}
...
### Darkolivegreen
```{r Liver darkolivegreen, echo=FALSE}
...
### Limegreen
```{r Prefrontal Cortex limegreen, echo=FALSE}
...
### Rosybrown2
```{r Prefrontal Cortex rosybrown2, echo=FALSE}
...
### Lavenderblush2
```{r Prefrontal Cortex lavenderblush2, echo=FALSE}
...
### Antiquewhite
```{r Prefrontal Cortex antiquewhite, echo=FALSE}
...
### Pink
```{r Prefrontal Cortex pink, echo=FALSE}
...
###Lightpink1
```{r Prefrontal Cortex lightpink1, echo=FALSE}
...
### Goldenrod3
```{r Prefrontal Cortex goldenrod3, echo=FALSE}
...
### Aquamarine
```{r Prefrontal Cortex aquamarine, echo=FALSE}
...
### Grey
```{r Skeletal Muscle grey, echo=FALSE}
...
### Green4
```{r Small Intestine green4, echo=FALSE}
...
### Blue2
```{r Small Intestine blue2, echo=FALSE}
...
### Cornsilk
```{r Small Intestine cornsilk, echo=FALSE}
...
### Magenta2
```{r Small Intestine magenta2, echo=FALSE}
...
### Darkgoldenrod4
```{r Small Intestine darkgoldenrod4, echo=FALSE}
...
### Mediumpurple1
```{r Spleen mediumpurple1, echo=FALSE}
...
### Palevioletred3
```{r Spleen palevioletred3, echo=FALSE}
