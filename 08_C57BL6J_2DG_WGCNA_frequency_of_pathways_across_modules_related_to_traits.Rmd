---
title: "Frequency of Pathways by Module-Trait Relationship"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset <- log.tdata.FPKM.sample.info %>% rownames_to_column() %>% column_to_rownames()

log.tdata.FPKM.subset <- subset(log.tdata.FPKM.sample.info.subset, select = -c(Time,Treatment,Tissue))
...
Treatment <- unclass(as.factor(log.tdata.FPKM.sample.info.subset[,27238]))
Tissue <- unclass(as.factor(log.tdata.FPKM.sample.info.subset[,27239]))
Time <- unclass(as.factor(log.tdata.FPKM.sample.info.subset[,27237]))
...
nSamples <- nrow(log.tdata.FPKM.sample.info.subset)
