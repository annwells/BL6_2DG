---
title: "Chang B6 96hr 4wk 2DG Eigenmetabolite Stratification Heart"
author: Ann Wells
...
log.tdata.FPKM.sample.info.subset.heart$Treatment[log.tdata.FPKM.sample.info.subset.heart$Treatment=="None"] <- "Control"

log.tdata.FPKM.sample.info.subset.heart <- cbind(log.tdata.FPKM.sample.info.subset.heart, "Time.Treatment" = paste(log.tdata.FPKM.sample.info.subset.heart$Time, log.tdata.FPKM.sample.info.subset.heart$Treatment))

module.labels <- readRDS(here("Data","Heart","log.tdata.FPKM.sample.info.subset.heart.WGCNA.module.labels.RData"))
module.eigens <- readRDS(here("Data","Heart","log.tdata.FPKM.sample.info.subset.heart.WGCNA.module.eigens.RData"))
...
eigenmetabolite(factors,log.tdata.FPKM.sample.info.subset.heart)
```
...
model.data = dplyr::bind_cols(module.eigens[rownames(log.tdata.FPKM.sample.info.subset.heart),], log.tdata.FPKM.sample.info.subset.heart[,c("Time","Treatment")])
