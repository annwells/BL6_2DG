...
eigens <- read.csv(here("Data","SM.SI.spleen.96hrs","log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs.WGCNA.module.eigens.csv"), header=T)
```
...
```{r, results = 'asis'}
eigen.expression(eigens,log.tdata.FPKM.sample.info.subset.SM.SI.spleen.96hrs)
```
