---
title: "Chang_B6_96hr_4wk 2DG Differential Expression Skeletal small.intestine"
author: Ann Wells
...
for(i in 1:length(log.tdata.FPKM.subset)){
  m <- art(data = log.tdata.FPKM.sample.info.subset.small.intestine, log.tdata.FPKM.subset[,i] ~ Time*Treatment)
...
saveRDS(Treatment.sig.only, here("Data","Small Intestine","Chang_2DG_BL6_DE_genes_small_intestine.RData"))
```
...
frame %>%
  download_this(
    output_name = "Small Intestine ANOVA Gene Differential Expression",
