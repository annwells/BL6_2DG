---
title: "C57BL6J 2DG Pathway Analysis"
author: Ann Wells
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset, log.tdata.FPKM.sample.info.subset[,genes[i]] ~ Time*Treatment*Tissue)
...
saveRDS(stat.table,here("Data","C57BL6J_WGCNA_gene_ANOVA_ART.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","C57BL6J_WGCNA_gene_ANOVA_ART.RData"))
