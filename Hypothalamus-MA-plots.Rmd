## MA plot for Hypothalamus 2DG 4wks {.tabset .tabset-fade .tabset-pills}
```{r Hypothalamus 2DG 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Hypothalamus control 4wks {.tabset .tabset-fade .tabset-pills}
```{r Hypothalamus control 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Hypothalamus 2DG 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Hypothalamus 2DG 96hrs MA plot, results='asis',cache=TRUE}
...
## MA plot for Hypothalamus control 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Hypothalamus control 96hrs MA plot, results='asis',cache=TRUE}
