...
```{r Hypothalamus 2DG 4wks MA plot, results='asis'}
...
```{r Hypothalamus control 4wks MA plot, results='asis'}
...
```{r Hypothalamus 2DG 96hrs MA plot, results='asis'}
...
```{r Hypothalamus control 96hrs MA plot, results='asis'}
