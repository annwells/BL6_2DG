...
tES <- GSVA.modules(modules, log.data.FPKM.subset.skeletal.muscle)

saveRDS(tES,here("Data","Skeletal Muscle","GSVA.modules.skeletal.muscle.RData"))
```
...
GSVA.table(log.tdata.FPKM.sample.info.subset.skeletal.muscle, tES)
```