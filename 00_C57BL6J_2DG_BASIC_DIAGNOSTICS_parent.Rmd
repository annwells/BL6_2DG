...
```{r PCA logged all data, child='knitr-pca-logged-all-data.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-single-timepoint.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-single-treatment.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-single-tissue.Rmd'}
```

***

# PCA (log Tissue 96 hr 2DG) {.tabset .tabset-fade .tabset-pills}
These plots subset the data so each plot contains mice treated with 2DG for 96hrs for each tissue.

```{r PCA logged time, child='knitr-pca-logged-96hr-2DG-tissue.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-96hr-control-tissue.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-4wk-control-tissue.Rmd'}
```

***

# PCA (log Treatment by tissue 96 hr) {.tabset .tabset-fade .tabset-pills}
These plots subset the data so each plot contains mice that were treated or untreated for 9hrs for each tissue.

```{r PCA logged time, child='knitr-pca-logged-treatment-tissue-96hr.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-treatment-tissue-4wk.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-time-tissue-2DG.Rmd'}
```
...
```{r PCA logged time, child='knitr-pca-logged-time-tissue-control.Rmd'}
```
