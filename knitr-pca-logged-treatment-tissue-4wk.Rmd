...
## Treatment Spleen
```{r spleen log PCA Treatment 4wk}
...
## Treatment kidney
```{r kidney log PCA Treatment 4wk}
...
```{r hypothalamus log PCA Treatment 4wk}
...
```{r hippocampus log PCA Treatment 4wk}
...
```{r small.intestine log PCA Treatment 4wk}
...
```{r skeletal.muscle log PCA Treatment 4wk}
...
```{r PCA prefrontal.cortex log 4wk}
tdata.FPKM.sample.info <- readRDS(here("Data","20190406_RNAseq_B6_4wk_2DG_counts_phenotypes.RData"))
...
```{r prefrontal.cortex log PCA Treatment 4wk}
