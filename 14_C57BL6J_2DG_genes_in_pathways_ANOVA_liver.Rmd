---
title: "Chang_B6_96hr_4wk 2DG Pathway Analysis Liver"
author: Ann Wells
...
WGCNA.gene <-readRDS(here("Data","Liver","Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_liver_WGCNA.RData"))
...
log.tdata.FPKM.sample.info.subset.liver$Tissue <- as.factor(log.tdata.FPKM.sample.info.subset.liver$Tissue)
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset.liver, log.tdata.FPKM.sample.info.subset.liver[,genes[i]] ~ Time*Treatment)
...
saveRDS(stat.table,here("Data","Liver","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_liver.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","Liver","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_liver.RData"))
