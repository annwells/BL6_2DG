...
for(i in 1:length(modules.tissue)){
  for(j in 1:length(modules.tissue)){
    ...
    pheatmap(correlations, show_rownames = T,show_colnames = T, fontsize_col = 4, fontsize_row = 2, color = colorRampPalette(rev(brewer.pal(n = 11, name =
  "Spectral")))(100))
    cat("\n \n")
  }
}
...
```{r corr loop liver, results='asis'}
  for(j in 1:length(modules.tissue)){
    ...
    pheatmap(correlations, show_rownames = T,show_colnames = T, fontsize_col = 4, fontsize_row = 4, color = colorRampPalette(rev(brewer.pal(n = 11, name =
  "Spectral")))(100), cluster_rows = F)
    cat("\n \n")
  }
