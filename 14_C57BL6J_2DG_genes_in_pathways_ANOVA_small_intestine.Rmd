---
title: "Chang_B6_96hr_4wk 2DG Pathway Analysis Small Intestine"
author: Ann Wells
...
WGCNA.gene <-readRDS(here("Data","Small Intestine","Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_small_intestine_WGCNA.RData"))
...
log.tdata.FPKM.sample.info.subset.small.intestine$Tissue <- as.factor(log.tdata.FPKM.sample.info.subset.small.intestine$Tissue)
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset.small.intestine, log.tdata.FPKM.sample.info.subset.small.intestine[,genes[i]] ~ Time*Treatment)
...
saveRDS(stat.table,here("Data","Small Intestine","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_small_intestine.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","Small Intestine","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_small_intestine.RData"))
