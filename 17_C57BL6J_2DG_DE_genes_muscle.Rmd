---
title: "Chang_B6_96hr_4wk 2DG Differential Expression Skeletal Muscle"
author: Ann Wells
...
for(i in 1:length(log.tdata.FPKM.subset)){
  m <- art(data = log.tdata.FPKM.sample.info.subset.skeletal.muscle, log.tdata.FPKM.subset[,i] ~ Time*Treatment)
...
saveRDS(Treatment.sig.only, here("Data","Skeletal Muscle","Chang_2DG_BL6_DE_genes_muscle.RData"))
```
...
frame %>%
  download_this(
    output_name = "Skeletal Muscle ANOVA Gene Differential Expression",
