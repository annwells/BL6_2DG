---
title: "Chang B6 96hr 4wk 2DG Pathway Analysis Brain"
author: Ann Wells
...
```{r}
WGCNA<-read.table(here("Data","Brain","log.tdata.FPKM.sample.info.subset.hip.hyp.cortex.WGCNA.module.membership.csv"), header=T)

Data_setup(WGCNA, file = "Annotated_genes_in_hip_hyp_cortex_WGCNA_Chang_B6_96hr_4wk.RData", folder="Brain")

Matched<-readRDS(here("Data","Brain","Annotated_genes_in_hip_hyp_cortex_WGCNA_Chang_B6_96hr_4wk.RData"))
  
pathways(Matched, pathwayfile = "Chang_B6_96hr_4wk_gprofiler_pathway_annotation_list_hip_hyp_cortex_WGCNA.RData", genefile = "Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_hip_hyp_cortex_WGCNA.RData", folder = "Brain")
...
#pdf("Counts_of_each_pathway_identified_within_brain.pdf")
