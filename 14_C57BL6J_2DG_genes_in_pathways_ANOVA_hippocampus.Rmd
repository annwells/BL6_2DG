---
title: "Chang_B6_96hr_4wk 2DG Pathway Analysis Hippocampus"
author: Ann Wells
...
WGCNA.gene <-readRDS(here("Data","Hippocampus","Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_hippocampus_WGCNA.RData"))
...
log.tdata.FPKM.sample.info.subset.hippocampus$Tissue <- as.factor(log.tdata.FPKM.sample.info.subset.hippocampus$Tissue)
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset.hippocampus, log.tdata.FPKM.sample.info.subset.hippocampus[,genes[i]] ~ Time*Treatment)
...
saveRDS(stat.table,here("Data","Hippocampus","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_hippocampus.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","Hippocampus","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_hippocampus.RData"))
