---
title: "Module Generation Prefrontal Cortex"
author: Ann Wells
...
soft <- pickSoftThreshold(log.tdata.FPKM.sample.info.subset.prefrontal.cortex.WGCNA, powerVector=powers, verbose=0)
```
