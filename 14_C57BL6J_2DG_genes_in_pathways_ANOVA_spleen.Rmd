---
title: "Chang_B6_96hr_4wk 2DG Pathway Analysis Spleen"
author: Ann Wells
...
WGCNA.gene <-readRDS(here("Data","Spleen","Chang_B6_96hr_4wk_gprofiler_gene_annotation_list_spleen_WGCNA.RData"))
...
log.tdata.FPKM.sample.info.subset.spleen$Tissue <- as.factor(log.tdata.FPKM.sample.info.subset.spleen$Tissue)
...
stat.table <- foreach(i = 1:length(genes),.packages = c("ARTool","tidyverse","kableExtra")) %dopar% {
   m2 <- art(data = log.tdata.FPKM.sample.info.subset.spleen, log.tdata.FPKM.sample.info.subset.spleen[,genes[i]] ~ Time*Treatment)
...
saveRDS(stat.table,here("Data","Spleen","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_spleen.RData"))
```

```{r, results='asis', cache = TRUE}

stat.table <- readRDS(here("Data","Spleen","Chang_B6_96hr_4wk_WGCNA_gene_ANOVA_ART_spleen.RData"))
