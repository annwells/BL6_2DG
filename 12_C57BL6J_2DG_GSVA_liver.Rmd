---
title: "Chang B6 96hr 4wk 2DG Gene Set Variation Analysis Liver"
author: Ann Wells
...
log.data.FPKM.subset.liver <- log.tdata.FPKM.sample.info.subset.liver %>%
...
tES <- GSVA.modules(modules, log.data.FPKM.subset.liver)

saveRDS(tES,here("Data","Liver","GSVA.modules.liver.RData"))
```
...
GSVA.table(log.tdata.FPKM.sample.info.subset.liver, tES)
```