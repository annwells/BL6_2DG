...
```{r Skeletal Muscle 2DG 4wks MA plot, results='asis'}
...
```{r Skeletal Muscle control 4wks MA plot, results='asis'}
...
```{r Skeletal Muscle 2DG 96hrs MA plot, results='asis'}
...
```{r Skeletal Muscle control 96hrs MA plot, results='asis'}
