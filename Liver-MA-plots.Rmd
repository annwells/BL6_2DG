...
```{r Liver 2DG 4wks MA plot, results='asis'}
...
```{r Liver control 4wks MA plot, results='asis'}
...
```{r Liver 2DG 96hrs MA plot, results='asis'}
...
```{r Liver control 96hrs MA plot, results='asis'}
