## MA plot for Liver 2DG 4wks {.tabset .tabset-fade .tabset-pills}
```{r Liver 2DG 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Liver control 4wks {.tabset .tabset-fade .tabset-pills}
```{r Liver control 4wks MA plot, results='asis',cache=TRUE}
...
## MA plot for Liver 2DG 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Liver 2DG 96hrs MA plot, results='asis',cache=TRUE}
...
## MA plot for Liver control 96hrs {.tabset .tabset-fade .tabset-pills}
```{r Liver control 96hrs MA plot, results='asis',cache=TRUE}
