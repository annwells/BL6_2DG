---
title: "Chang_B6_96hr_4wk 2DG Differential Expression Spleen"
author: Ann Wells
...
for(i in 1:length(log.tdata.FPKM.subset)){
  m <- art(data = log.tdata.FPKM.sample.info.subset.spleen, log.tdata.FPKM.subset[,i] ~ Time*Treatment)
...
saveRDS(Treatment.sig.only, here("Data","Spleen","Chang_2DG_BL6_DE_genes_spleen.RData"))
```
...
frame %>%
  download_this(
    output_name = "Spleen ANOVA Gene Differential Expression",
