...
### Tissue
This boxplot groups control and treated samples for each time point and tissue but displays the data by timepoint.
...
### Treatment
This boxplot groups timepoints for each treatment and tissue.
```{r treatment boxplot}
tdata.FPKM.sample.info <- readRDS(here("Data","20190406_RNAseq_B6_4wk_2DG_counts_phenotypes.RData"))
...
### Time by treatment
This plot displays treatment and time for each tissue.
...
### Tissue
This plot groups treatment and timepoint for each tissue.
...
pheatmap::pheatmap(mat.dist, color = rev(hmcol), fontsize = 3)
```
